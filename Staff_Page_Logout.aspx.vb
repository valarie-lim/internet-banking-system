Public Class Staff_Page_Logout
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            If Session("StaffLoginTime") IsNot Nothing Then
                loginTime = Convert.ToDateTime(Session("StaffLoginTime"))
            End If

            If Session("StaffLogoutTime") IsNot Nothing Then
                logoutTime = Convert.ToDateTime(Session("StaffLogoutTime"))
                LogoutTimestamp.Text = logoutTime.ToString("dd-MMM-yyyy hh:mm tt")
            End If

            ' Only calculate duration if both exist
            If Session("StaffLoginTime") IsNot Nothing AndAlso Session("StaffLogoutTime") IsNot Nothing Then
    ...
    Private Sub BtnBackHome_Click(sender As Object, e As EventArgs) Handles BtnBackHome.Click
        Response.Redirect("Staff_Page_Home.aspx")
    End Sub
End Class