...
Public Class admin_main_menu
    ...
    Private Sub BtnCustomerManagement_Click(sender As Object, e As EventArgs) Handles BtnCustomerManagement.Click
        Response.Redirect("client_management.aspx")
    End Sub
    ...
    Private Sub BtnAddLocalCustomer_Click(sender As Object, e As EventArgs) Handles BtnAddLocalCustomer.Click
        Response.Redirect("client_account_registration.aspx")
    End Sub
End Class