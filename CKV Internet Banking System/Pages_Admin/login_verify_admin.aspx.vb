...
Public Class login_verify_admin
    ...
    Protected Sub RblPhraseConfirm_SelectedIndexChanged(sender As Object, e As EventArgs)
        ...
        Else
            ...
            ScriptManager.RegisterStartupScript(Me, Me.GetType(), "alert", "alert('Login abort!'); setTimeout(function(){ window.location='login_admin.aspx'; }, 0);", True)
        End If
    End Sub
                ...
                Using loginCommand As New SqlCommand(sql, connection)
                    ...
                    Using reader As SqlDataReader = loginCommand.ExecuteReader()
                        ...
                        If dbPassHash.SequenceEqual(enteredHash) Then
                            ...
                            ClientScript.RegisterStartupScript(Me.GetType(), "alert", "alert('Welcome to CKV Bank Management System.'); window.location='admin_main_menu.aspx';", True)
