<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="fund_transfer_successful.aspx.vb" Inherits="CKV_Internet_Banking_System.fund_transfer_successful" %>
            ...
            <div class="right-menu-container">
                ...
                <div>
                    ...
                    <asp:Button ID="BtnNewTransaction" runat="server"
                        CssClass="btn-style-normal" Text="Make Another Transfer" />
                    <br />
