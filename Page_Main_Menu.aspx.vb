...
Public Class Page_Main_Menu
    ...
    Protected Sub GridView1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles GridView1.SelectedIndexChanged
        ' Get the selected AccountId from DataKeys
        Dim selectedAccountId As Integer = Convert.ToInt32(GridView1.SelectedDataKey("account_id"))

        ' Store in session for later use
        Session("SelectedAccountId") = selectedAccountId
