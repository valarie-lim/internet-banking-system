...
Public Class Page_Forgot_Pass
    ...
    Private Sub BtnSendCode_Click(sender As Object, e As EventArgs) Handles BtnSendCode.Click
        ...
        Try
            ...
            ClientScript.RegisterStartupScript(Me.GetType(), "alert",
                "alert('If the email address is registered for this account, you will receive a verification code.'); window.location='Page_Forgot_Pass_Verify.aspx';", True)
    ...
    Private Sub BtnCancel_Click(sender As Object, e As EventArgs) Handles BtnCancel.Click
        Response.Redirect("Page_Login_Verify.aspx")
    End Sub
End Class